...
!((t, e) => {
	...
	function N(t) {
		return (
			!((t) =>
				...
				("object" == typeof t &&
					null !== t &&
					!(Symbol.toPrimitive in t || "toString" in t || "valueOf" in t)))(t) &&
			!isNaN(parseFloat(t)) &&
			isFinite(t)
		);
	}
	...
	class _n {
		constructor(t) {
			(this._config = ((t) => (((t = t || {}).data = gn(t.data)), fn(t), t))(t)),
	...
	function Ko(t) {
		...
		return (i, s) => {
			...
			n instanceof $n
				...
				: n instanceof Yn
					? (e = ((t, e) => ((t.backgroundColor = t.data.map(() => qo(e++))), e))(i, e))
					: n &&
						(e = ((t, e) => ((t.borderColor = Xo(e)), (t.backgroundColor = qo(e)), ++e))(i, e));
		};
	}
	function Go(t) {
		let e;
